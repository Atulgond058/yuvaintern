...
const FEATURES = [
  {
    ...
    body: "Doctor availability syncs the moment it changes, so a slot you can see is a slot you can book — no double-booking, ever.",
  },
  {
    title: "Automated triage",
    body: "A short symptom intake sorts each case into Routine, Urgent, or Emergency before a slot is even chosen, and routes it accordingly.",
  },
  {
    title: "Browser-native video",
    body: "Peer-to-peer video and chat run straight in the browser — nothing to install, with a relay fallback so calls still connect.",
  },
];
...
const STEPS = [
  {
    ...
    body: "Answer a short, structured set of questions about your symptoms, duration, and severity.",
  },
  {
    n: "02",
    title: "Get matched by urgency",
    body: "The triage engine classifies your case and surfaces the next appropriate appointment slot.",
  },
  {
    n: "03",
    title: "See a provider by video",
    body: "Join your consultation from any browser. Notes, records, and prescriptions stay in one place.",
  },
];
      ...
      <main id="main">
          ...
          <div className="container hero__grid">
            <div className="hero__copy">
              ...
              <h1 className="hero__headline">
                Care that keeps pace with how you actually feel.
              </h1>
              <p className="hero__sub">
                MediSync connects symptom triage, scheduling, secure video visits, and
                prescriptions into one calm, HIPAA-aware experience — for patients and the
                clinicians looking after them.
              </p>
              <div className="hero__actions">
                <Button as={Link} to="/dashboard" size="md">Go to my dashboard</Button>
                <Button as="a" href="#how-it-works" variant="secondary" size="md">See how it works</Button>
              </div>
              <p className="hero__trust">
                Encrypted end-to-end · No install required · Built for HIPAA-aligned care
              </p>
            </div>
            ...
            <div className="hero__panel" role="img" aria-label="Preview of a MediSync live consultation card showing a patient's vitals and an upcoming appointment">
              <div className="vitals-card">
                ...
                <Button as={Link} to="/appointments/appt_501" full size="sm">View appointment</Button>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container providers">
            <div>
              ...
              <p className="providers__body">
                Manage availability, review pre-triaged cases before a visit even starts, and
                issue signed e-prescriptions without leaving the consultation window.
              </p>
              <Button as={Link} to="/dashboard" variant="secondary">Open provider dashboard</Button>
            </div>
        ...
        <section className="cta">
          <div className="container cta__inner">
            ...
            <Button as={Link} to="/dashboard" size="md">Get started</Button>
          </div>
        </section>
      </main>
